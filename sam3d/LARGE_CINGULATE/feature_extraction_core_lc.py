"""
SAM-Med3D standard feature extraction for LARGE_CINGULATE dataset.
...
project_root = Path(__file__).parent.parent.parent  # sam3d/LARGE_CINGULATE/ -> adaptfoundation_linearprobing/
...
class SAMMed3DStandardExtractor:
    """
    SAM-Med3D standard feature extractor for LARGE_CINGULATE dataset.
    
    Provides feature extraction using SAM-Med3D turbo model with 
    standard flatten spatial aggregation for binary classification.
