...
def test_data_loading():
    ...
    """
    features_path = "feature_extraction_sam3d_sc"
    config_path = "sam3d/SC_sylv/regression_sc.yaml"
...
def test_regressor_config():
    ...
    """
    config = load_yaml_config("sam3d/SC_sylv/regression_sc.yaml")
    prober = SCLinearProber("feature_extraction_sam3d_sc")
