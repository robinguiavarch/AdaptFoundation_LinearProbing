"""
SAM-Med3D standard feature extraction for F.I.P. dataset.
...
project_root = Path(__file__).parent.parent.parent  # sam3d/FIP/ -> adaptfoundation_linearprobing/
...
class SAMMed3DStandardExtractor:
    """
    SAM-Med3D standard feature extractor for F.I.P. dataset.
