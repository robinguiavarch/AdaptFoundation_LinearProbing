...
def test_data_loading():
    ...
    """
    features_path = "feature_extracted_lc_dinov2"
    config_path = "dino/LARGE_CINGULATE/classification_lc.yaml"
...
def test_classifier_config():
    ...
    """
    config = load_yaml_config("dino/LARGE_CINGULATE/classification_lc.yaml")
    prober = LCLinearProber("feature_extracted_lc_dinov2")
