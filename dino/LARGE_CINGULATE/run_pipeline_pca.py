"""
Pipeline 2: PCA reduction for LARGE_CINGULATE feature maps features.
...
from dino.LARGE_CINGULATE.feature_extraction_core import StandalonePCAProcessor


class LCPCAPipeline:
    """
    Pipeline 2: PCA reduction for pre-extracted LARGE_CINGULATE feature maps features.
    ...
    def __init__(self, config_path: str):
        """
        Initialize LARGE_CINGULATE PCA pipeline.
        ...
        print(f"LARGE_CINGULATE PCA pipeline initialized:")
    ...
    def run_pca_reduction(self) -> None:
        ...
        print("=" * 80)
        print("PIPELINE 2: LARGE_CINGULATE PCA REDUCTION")
        print("=" * 80)
...
def main():
    """
    Main entry point for LARGE_CINGULATE PCA reduction pipeline.
    """
    parser = argparse.ArgumentParser(
        description="LARGE_CINGULATE PCA reduction - Pipeline 2",
    ...
    try:
        pipeline = LCPCAPipeline(str(config_path))
