...
def test_data_loading():
    ...
    """
    features_path = "../../feature_extracted_fip_dinov2"
    config_path = "classification_fip.yaml"
...
def test_classifier_config():
    ...
    """
    config = load_yaml_config("classification_fip.yaml")
    prober = FIPLinearProber("../../feature_extracted_fip_dinov2")
