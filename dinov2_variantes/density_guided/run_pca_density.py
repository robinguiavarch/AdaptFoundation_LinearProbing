"""
Pipeline 2: PCA reduction for density-guided CLS token features.

This script applies PCA reduction to pre-extracted raw CLS token features
...
from dinov2_variantes.density_guided.density_guided_core import StandalonePCAProcessor


class DensityGuidedPCAPipeline:
    """
    Pipeline 2: PCA reduction for pre-extracted density-guided CLS token features.
    ...
    def __init__(self, config_path: str):
        """
        Initialize density-guided PCA pipeline.
        ...
        print(f"Density-guided PCA pipeline initialized:")
    ...
    def run_pca_reduction(self) -> None:
        ...
        print("=" * 80)
        print("PIPELINE 2: DENSITY-GUIDED PCA REDUCTION")
        print("=" * 80)
...
def main():
    """
    Main entry point for density-guided PCA reduction pipeline.
    """
    parser = argparse.ArgumentParser(
        description="Density-guided PCA reduction - Pipeline 2",
    ...
    try:
        pipeline = DensityGuidedPCAPipeline(str(config_path))
